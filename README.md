...
Este repositório reúne projetos práticos desenvolvidos ao longo da minha jornada de aprendizado e evolução profissional através da DIO - Digital Innovation One, a maior plataforma de educação aberta em tecnologia da América Latina.

📌 Sobre este repositório
Aqui estão organizados os principais projetos que desenvolvi desde outubro de 2022 durante minha participação em:

✔️ Formações completas
✔️ Bootcamps intensivos
...
Bootcamps patrocinados por empresas de renome
Projetos práticos com orientação de especialistas
Desafios com feedback imediato
...
🎯 Objetivo
Este portfólio tem como objetivo demonstrar habilidades técnicas aplicadas na prática, minha evolução profissional e o comprometimento com a formação contínua como desenvolvedor full stack Developer, Excel com Inteligência Artificial, GenAI & Dados Bradesco, Marchine Learning e GenAI NEXA .
